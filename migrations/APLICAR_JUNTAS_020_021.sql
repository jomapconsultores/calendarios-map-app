-- =============================================================================
-- APLICAR JUNTAS — migraciones 020 y 021
-- Desarrollado por Marco Antonio Posligua San Martín
--
-- Es la union de 020_directorio_y_cronograma.sql y 021_sri_completo_y_plan_ia.sql
-- en el orden correcto, para pegarlas de una sola vez en el editor SQL de
-- Supabase. Ambas son idempotentes: ejecutarlo dos veces no rompe nada.
--
--   https://supabase.com/dashboard/project/lqdpirsfzodmbeyoivww/sql/new
-- =============================================================================
